...
class FuturesSelectionTests(unittest.TestCase):
    ...
    def test_macro_groups_are_target_groups(self):
        self.assertEqual(MarketTradingUniverseService.futures_group("BRU6"), MarketTradingUniverseService.OIL)
        self.assertEqual(MarketTradingUniverseService.futures_group("GDZ6"), MarketTradingUniverseService.GOLD)
        self.assertEqual(MarketTradingUniverseService.futures_group("NGU6"), MarketTradingUniverseService.GAS)
        self.assertEqual(MarketTradingUniverseService.futures_group("SIU6"), MarketTradingUniverseService.USDRUB)
        self.assertTrue(all(

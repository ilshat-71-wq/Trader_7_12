...
def test_session_boundaries_after_2026_schedule_change():
    ...
    assert SERVICE.get_session(datetime(2026, 9, 14, 9, 0, tzinfo=MSK)) == "MORNING"
    assert SERVICE.get_session(datetime(2026, 9, 14, 9, 59, 59, tzinfo=MSK)) == "MORNING"
    assert SERVICE.get_session(datetime(2026, 9, 14, 10, 0, tzinfo=MSK)) == "MAIN"
